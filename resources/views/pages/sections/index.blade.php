                                    ...
                                    <td>
                                        <div class="flex justify-end gap-1">
                                            ...
                                            <x-dropdown align="right" width="w-44">
                                                ...
                                                <x-slot name="content">
                                                    <form method="post" action="{{ route('sections.destroy', $section) }}" onsubmit="return confirm('Deactivate this section? It will no longer be available for new examinations.')">
                                                        @csrf
                                                        @method('DELETE')
